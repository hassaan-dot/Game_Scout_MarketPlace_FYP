  ...
  return (
    <>
      <div className="h-screen overflow-hidden">
        {!otpModalVisible && (
          <div className="flex flex-col lg:flex-row items-center justify-center h-full w-full bg-cover bg-center bg-no-repeat px-4 lg:px-12">
            <div className="hidden lg:flex flex-[1.2] bg-[#8C6DFD] h-[600px] rounded-3xl items-end p-12">
              <div className="text-white text-lg font-bold">
                Welcome back, you've been missed!
              </div>
            </div>

            <div className="flex-1 bg-opacity-5 shadow-lg rounded-3xl p-8 backdrop-blur-md w-full max-w-[600px] mt-10 lg:mt-0 lg:ml-10">
              {IsRegister && (
                <button
                  onClick={() => {
                    setIsRegister(false);
              ...
              <div className="flex flex-col items-center bg-white bg-opacity-10 rounded-xl p-4 text-white mt-6">
                ...
                <button
                  type="button"
                  onClick={handleLogin}
                  className="flex items-center gap-2 border border-white px-4 py-1 rounded-md hover:bg-white hover:text-black transition"
                >
                  <img
